...
{
    public partial class user_Tracker1 : Form
    {
        ...
        private void accountToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                txt1 = id.Text;
                new Pages.accountpass().ShowDialog();
            }
            catch (Exception ex)
            {
                con.Close();
        ...
        private void user_Tracker1_Load(object sender, EventArgs e)
        {
            label9.Text = Settings.Default.minS_U;
            timeleft1 = int.Parse(label9.Text);
            timer5.Enabled = true;
            try
            {
        ...
        {
            frmSettingsUser l = new frmSettingsUser();
            l.Show();
        }
