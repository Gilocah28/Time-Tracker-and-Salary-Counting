...
namespace PMTTS_Feb_10_2023.Pages
{
    public partial class frmSettingsAdmin : Form
    {
        ...
        {
            Settings.Default.nameS = guna2ComboBox1.Text;
            Settings.Default.minS = label2.Text;
        ...
        {
            guna2ComboBox1.Text = Settings.Default.nameS;
            label2.Text = Settings.Default.minS;
        }
    }
}
